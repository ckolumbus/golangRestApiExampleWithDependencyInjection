...
// Source: pkg/employee/persistence/IEmployeePersist.go
...
func (m *MockIEmployeePersist) GetAll() (dto.Employees, error) {
	ret := m.ctrl.Call(m, "GetAll")
	ret0, _ := ret[0].(dto.Employees)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAll indicates an expected call of GetAll
func (mr *MockIEmployeePersistMockRecorder) GetAll() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAll", reflect.TypeOf((*MockIEmployeePersist)(nil).GetAll))
}
